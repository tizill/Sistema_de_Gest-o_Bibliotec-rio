                        ...
                        <div class="row m-l-0 m-r-0">
                            <div class="col-sm-4 bg-c-lite-green user-profile">
                                <div class="card-block text-center text-white">
                                    ...
                                    <p>Funcionario</p> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="card-block">
                                    <h6 class="m-b-20 p-b-5 b-b-default f-w-600">Informações Do Funcionario</h6>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600">Email</p>
                                            <h6 class="text-muted f-w-400"><?php echo $linha['email'];?></h6>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600">Login/Senha:</p>
                                            <h6 class="text-muted f-w-400"><?php echo "Login: " . $linha['logon'] . '<br>' ."Senha: " . $linha['senha']; ?></h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <a href="cadastro_Funcionario.php" class="m-b-10 f-w-600 link-info">Voltar aos Cadastros.</a>
                                    </div>
                                </div>
                            </div>
                        </div>
