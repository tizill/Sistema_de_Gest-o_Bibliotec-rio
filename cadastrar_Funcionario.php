...
<form class="row g-3" action="conexoes/insert_func.php" id="FormFunc" method="POST">
        ...
        <input type="email" name="email" id="email" placeholder="@exemplo@gmail.com" class="form-control" onblur="validarEmail()" required>
        </div>
        ...
        <input type="password" name="ConfirmarSenha" onblur="validarSenha();" id="ConfirmarSenha" class="form-control input-md " required>
        </div>

        <div class="col-md-2">
        <label class="form-label" for="login"> login: *</label>
        <input type="text" name="login" id="login" class="form-control input-md " required>
        </div>
